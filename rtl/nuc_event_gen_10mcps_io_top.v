...
module nuc_event_gen_10mcps_io_top #(
    parameter integer SAMPLES_PER_CLK       = 1,
    parameter integer DAC_BITS              = 16,
    parameter integer AMP_BITS              = 16,
    parameter integer IMP_BITS              = 16,
    parameter integer ACC_BITS              = 21,
    parameter integer PULSE_BITS            = 20,
    parameter integer ICDF_ADDR_BITS        = 14,
    parameter integer FRAC_BITS             = 4,
    parameter [4:0]  DEFAULT_OUTPUT_SHIFT   = 5'd4,
    parameter integer MAX_EVENTS_PER_SAMPLE = 3,
    parameter integer DECAY_BEFORE_ACCUMULATE = 0,
    parameter [4:0]  FIXED_DECAY_SHIFT      = 5'd8,
    parameter integer ENABLE_STATE_OVERFLOW = 0,
    parameter integer ENABLE_STATUS_COUNTERS = 0
) (
    input  wire                                clk,
    input  wire                                rst_n,
